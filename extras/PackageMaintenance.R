...
OhdsiRTools::checkUsagePackage("glpHiraV1")
OhdsiRTools::updateCopyrightYearFolder()
devtools::spell_check()

# Create manual -----------------------------------------------------------
unlink("extras/glpHiraV1.pdf")
shell("R CMD Rd2pdf ./ --output=extras/glpHiraV1.pdf")
...
OhdsiRTools::createRenvLockFile("glpHiraV1")
